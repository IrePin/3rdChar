...
namespace UnityEngine.PostProcessing
{
    ...
    public class SubsurfaceScatteringProfile : ScriptableObject
    {
        ...
        private Color scatteringDistance;         // Per color channel (no meaningful units)
        [ColorUsage(false)]
        ...
        public Color ScatteringDistance { get => scatteringDistance; set => scatteringDistance = value; }
